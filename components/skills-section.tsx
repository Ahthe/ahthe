...
const SkillsSection: React.FC = () => {
  return (
    <section className="mt-12 mb-6"> {/* Add margin-top */}
      ...
      <ul className="inline-flex flex-wrap gap-3"> {/* Adjusted gap slightly */}
        {skillsData.map((skill) => (
          <li
            ...
            className="flex items-center gap-1.5 rounded-md border border-neutral-200/80 dark:border-neutral-700/60 bg-neutral-100 dark:bg-neutral-800/50 px-2 py-1 text-xs text-neutral-700 dark:text-neutral-300 shadow-sm mb-3" // Adjusted styles slightly for React theme
          >
