...
<LinkCardList
  cards={[
    {
      title: "client",
      link: "https://github.com/ahthe/course/blob/master/lib/supabase/client.ts",
    },
    {
      title: "server",
      link: "https://github.com/ahthe/course/blob/master/lib/supabase/server.ts",
    },
    {
      title: "middleware",
      link: "https://github.com/ahthe/course/blob/master/lib/supabase/middleware.ts",
    },
  ]}
/>
