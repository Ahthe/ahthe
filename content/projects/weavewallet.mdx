...
publishedAt: "2024-07-26" # Adjust the date as needed
...
<div className="my-4 overflow-hidden rounded-lg border border-zinc-200 dark:border-zinc-700">
  <img 
    src="/images/projects/wreakeditdown-gameplay.gif" 
    alt="Wreak It Down gameplay showing player shooting at enemies" 
    width={800} 
    height={450} 
...
> **Note about GIFs**: While GIFs are great for showcasing gameplay, they can impact site performance if they're too large. For this blog, I've used a compressed, optimized GIF with lazy loading. For more intensive demonstrations, consider using short MP4 videos which provide better compression while maintaining quality.
