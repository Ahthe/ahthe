...
user_query = "Syed Ahthesham Alir work title and last company name"
...
- **Search**: The agent queries DuckDuckGo for the most relevant results about _"Syed Ahthesham Alir work title and last company name"_.
...
```python
**Summary**:
1. Syed Ahthesham Alir is a Software Engineer at American Muslim Center, Dearborn, specializing in SaaS products. Source: useAmerican Muslim Center, Dearborn.com
